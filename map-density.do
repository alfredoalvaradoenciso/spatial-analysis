...
preserve
keep if any==1 
*spgrid using "$base\Lima_xy2", shape(square) xdim(100) verbose compress cells("$base\ctemp.dta") points("$base\ptemp.dta") replace 
...
graph export "$img\mapa_densidad_lima.png",replace
